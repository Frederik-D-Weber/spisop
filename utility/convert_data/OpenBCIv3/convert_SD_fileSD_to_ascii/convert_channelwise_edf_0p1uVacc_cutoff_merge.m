function convert_channelwise_edf_0p1uVacc_cutoff_merge(currentFullInstallationFilePath,fileFilterSettings,fileRerefSettings,DoReReference,linearDeviationMontagePath,ApplyLinearDeviationMontage)
%dbstop if error
%clear
