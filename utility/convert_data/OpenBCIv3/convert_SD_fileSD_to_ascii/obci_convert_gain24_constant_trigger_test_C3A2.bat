...
SET settingsFile=split_pure_lindev_filter_home_jingyi_setup1_spind_slow_alpha_constant_trigger_test_C3A2.txt
SET linearDeviationFile=linear_deviation_sleep_scoring_test_C3A2.txt
