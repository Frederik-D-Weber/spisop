...
SET settingsFile=split_pure_lindev_filter_home_jingyi_setup1_spind_slow_alpha_constant_trigger.txt
...
ECHO  convert brainvision_int32
obci_convert_gain24.exe brainvision_int32 %pathPrefix% %settingsFile% linearDeviationMontagePath=%linearDeviationFile%

ECHO  convert brainvision_float32
obci_convert_gain24.exe brainvision_float32 %pathPrefix% %settingsFile% linearDeviationMontagePath=%linearDeviationFile%
