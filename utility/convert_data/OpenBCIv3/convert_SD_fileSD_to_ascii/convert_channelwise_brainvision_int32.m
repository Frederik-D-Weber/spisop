function convert_channelwise_brainvision_int32(currentFullInstallationFilePath,fileFilterSettings,fileRerefSettings,DoReReference,linearDeviationMontagePath,ApplyLinearDeviationMontage)
...
%                 end
                ...
                data_file_name_current = [data_file_name_current '_' 'reref' '_' brainvision_outformat];
            ...
            if strcmp(ApplyLinearDeviationMontage,'yes')
                ...
                hdr.brainvision_outformat = 'int32';%float32 int16 int32;
                data_file_name_current = [data_file_name_current '_' 'lindev' '_' brainvision_outformat];
                ft_write_data([data_file_name_current '.eeg'], data.trial{:},'dataformat',dataformat,'header',hdr);
            end
        end
