function convert_channelwise_edf_autoscale(currentFullInstallationFilePath,fileFilterSettings,fileRerefSettings,DoReReference,linearDeviationMontagePath,ApplyLinearDeviationMontage)
...
%                 end
        ...
        data_file_name_current = [data_file_name_current '_' 'filtered' '_' 'autoscaled'];
