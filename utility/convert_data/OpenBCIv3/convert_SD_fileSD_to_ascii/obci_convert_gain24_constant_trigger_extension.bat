...
SET settingsFile=split_pure_lindev_filter_home_jingyi_setup1_spind_slow_alpha_constant_trigger_extension.txt
SET linearDeviationFile=linear_deviation_sleep_scoring_extension.txt
