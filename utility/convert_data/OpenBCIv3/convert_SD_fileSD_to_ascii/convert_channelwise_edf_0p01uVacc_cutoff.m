function convert_channelwise_edf_0p01uVacc_cutoff(currentFullInstallationFilePath,fileFilterSettings,fileRerefSettings,DoReReference,linearDeviationMontagePath,ApplyLinearDeviationMontage)
%dbstop if error
%clear
...
%                 end
        ...
        data_file_name_current = [data_file_name_current '_' 'filtered' '_' '0p01uVaccurracy_and_Ycutoff'];
